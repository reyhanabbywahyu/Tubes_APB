...
val nama_obat_Flu_List : MutableList<String> = mutableListOf("Brother", "me,Scott Jennifer","Sandra Adams","Trevor Hansen","Britta Holt")
val jumlah_jual_Flu_List : MutableList<String> = mutableListOf("Brunch this Weekend?", "Summer BBQ", "Oui Oui", "Order Confirmation", "Receipe to try")
val harga_Flu_List : MutableList<String> = mutableListOf("15m", "2h", "6h", "12h", "18h")
val dataObatFlu : MutableList<Obat> = mutableListOf(
obat1Demam, obat2Demam,
obat3Demam, obat4Demam,
obat5Demam, obat6Demam)
class Flu_Obat_Adapter(val onclick : TokoObatAdapter.onClickListener ) : RecyclerView.Adapter<Flu_Obat_Adapter.HolderData>(),Filterable {
    var FilterList : MutableList<Obat> = dataObatFlu
